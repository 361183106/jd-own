...
let inviteCodes = [
    'RtGKz-XxF1ilfdfOFdcxgOOW9xU19xHtmXRP4UGtcB9LCr_byQ@HozkwOutQw-jEd7WW5gzmk9CF6Q0B1W6q27DMpNsdqw@yxVhH34al4wbpzM3wH6HA8NSvp3Kym6DWM1_4PlXu396FWp74R3TwLeC@RtGKqbnEG2jhJdLzc7Bnmls-oOTjQIuZIj9j4LEKD7_YxLvK@RtGKz-j2Rwr1LILPFtc1gMHbwFgHfpdqAi-VAoAob6jW44AzIg'
]
!(async () => {
    if (!cookiesArr[0]) {
...
function requireConfig() {
    return new Promise(resolve => {
        ...
        if ($.isNode()) {
            ...
            if (process.env.CITY_SHASHARECODESRECODES) {
