...
[task_local]
#每日抽奖
13 1,22,23 * * * https://gitee.com/Misyi/jd-own/raw/master/jd_own_daily_lottery.js, tag=每日抽奖, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=====================Loon================
[Script]
cron "13 1,22,23 * * *" script-path=https://gitee.com/Misyi/jd-own/raw/master/jd_own_daily_lottery.js, tag=每日抽奖

====================Surge================
每日抽奖 = type=cron,cronexp="13 1,22,23 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/Misyi/jd-own/raw/master/jd_own_daily_lottery.js

============小火箭=========
每日抽奖 = type=cron,script-path=https://gitee.com/Misyi/jd-own/raw/master/jd_own_daily_lottery.js, cronexpr="13 1,22,23 * * *", timeout=3600, enable=true
*/
const $ = new Env('每日抽奖');
